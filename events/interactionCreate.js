...
module.exports = (client, inter) => {
    ...
    if (!command) return inter.reply({ embeds: [ new EmbedBuilder().setColor('#ff0000').setDescription('❌ | Error! Please contact Developers! (Ultra Smash#1434)')], ephemeral: true, }), client.slash.delete(inter.commandName)
